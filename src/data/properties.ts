...
export const properties: Property[] = [
  ...
  // ─── KARK LAND PLOTS - Premium Development Land ────────────────────────────
  {
    id: 'kark-land-plot-1',
    title: 'Premium Land Plot in Kark - Plot A1',
    titleKu: 'زەوی لە کارک - پارچەی A1',
    titleAr: 'أرض فاخرة في كارك - قطعة A1',
    type: 'Land',
    price: 250000,
    priceIQD: 367500000,
    status: 'For Sale',
    ...
    location: {
      address: 'Kark Development Zone',
      city: 'Erbil',
      district: 'Kark',
      country: 'Iraq',
      coordinates: { lat: 36.263632, lng: 44.022134 },
      nearbyLandmarks: ['Main Highway', 'Residential Towers', 'Green Belt']
    },
    specs: {
      beds: 0,
      baths: 0,
    ...
    description: `Prime development land in the rapidly growing Kark area of Erbil. This 600 sqm plot is part of an organized development with paved roads and infrastructure already in place.

Located in a strategic position with easy access to the main highway and surrounded by established residential towers. The area is experiencing rapid growth with new construction and increasing property values.

Perfect for building your dream villa or as an investment opportunity in one of Erbil's most promising development zones. All utilities and road access are ready.

Contact us for site visits and detailed plot maps.`,
    features: [
      'Paved Roads',
    ...
    neighborhood: {
      name: 'Kark',
      walkScore: 60,
      description: 'Emerging development area with modern infrastructure, residential towers, and excellent growth potential.'
    },
    agent: agents[0]
  },
  {
    id: 'kark-land-plot-2',
    title: 'Corner Land Plot in Kark - Plot B1',
    titleKu: 'زەوی گۆشە لە کارک - پارچەی B1',
    titleAr: 'أرض زاوية في كارك - قطعة B1',
    type: 'Land',
    price: 320000,
    priceIQD: 470400000,
    status: 'For Sale',
    badges: ['Hot', 'Exclusive'],
    location: {
      address: 'Kark Development Zone, Corner Plot',
      city: 'Erbil',
      district: 'Kark',
      country: 'Iraq',
      coordinates: { lat: 36.263700, lng: 44.022200 },
      nearbyLandmarks: ['Main Highway', 'Residential Towers', 'Green Belt']
    },
    specs: {
      beds: 0,
    ...
    description: `Premium corner plot in Kark's organized development zone. At 750 sqm, this corner position offers maximum visibility and design flexibility for your dream project.

Corner lots are highly sought after for their additional road frontage and better ventilation. Infrastructure including paved roads and utilities are already in place.

The Kark area is rapidly developing with new residential towers visible in the aerial photos. This is an excellent opportunity for both end-users and investors looking for capital appreciation.

Limited corner plots available - contact us today!`,
    features: [
      'Corner Position',
      'Two Road Frontage',
      'Paved Roads',
  ...
  {
    id: 'kark-land-plot-3',
    title: 'Investment Land in Kark - Plot C1',
    titleKu: 'زەوی وەبەرهێنان لە کارک - پارچەی C1',
    titleAr: 'أرض استثمارية في كارك - قطعة C1',
    type: 'Land',
    price: 200000,
    priceIQD: 294000000,
    status: 'For Sale',
    ...
    location: {
      ...
      district: 'Kark',
      country: 'Iraq',
      coordinates: { lat: 36.263500, lng: 44.022000 },
      nearbyLandmarks: ['Main Highway', 'Residential Towers', 'Green Belt']
    },
    specs: {
      beds: 0,
    ...
    description: `Affordable land plot in Kark's premium development zone. This 500 sqm plot offers an excellent entry point into one of Erbil's most promising areas.

Installment payment plans available - making property ownership accessible. The plot comes with all infrastructure ready including paved roads and utility connections.

Ideal for first-time buyers or investors looking to build equity. The Kark area is surrounded by established residential developments and offers strong growth potential.

Ask about our flexible payment options!`,
    features: [
